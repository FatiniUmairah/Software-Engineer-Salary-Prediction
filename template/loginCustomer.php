...
<body>
    <head>
        <title>login Customer | Software Engineer Salary Prediction</title>
<meta charset="UTF-8">
...
<!-- Navbar Start -->
 ...
 <!-- <a href="teams.html" class="nav-item nav-link ">Teams Members</a>-->
    ...
    <form name="form" method="POST" action="{{ url_for('login_customer') }}">
    <h3>LOGIN CUSTOMER</h3>
    Username: <input name="CUST_USERNAME" type="text" placeholder="Enter Username" id="CUST_USERNAME" required><br>
    Password: <input name="CUST_PASS" type="password" placeholder="Enter Password" id="CUST_PASS" required><br>

    <input type="submit" name="Submit" value="Login" onclick="return check();">

    <a href="{{ url_for('register_customer') }}">Don't have an account yet? Register</a>
</form>
