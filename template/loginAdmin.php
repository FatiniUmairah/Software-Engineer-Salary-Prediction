...
<body>
    <head>
        <title>Login Admin | Software Engineer Salary Prediction</title>
        <meta charset="UTF-8">
...
<!-- Navbar Start -->
    ...
    <!-- Navbar End -->
<!-- Form action updated to submit to the /loginAdmin route -->
<!-- Form action updated to submit to the /loginAdmin route -->
<form name="form" method="post" action="{{ url_for('login_admin') }}" onsubmit="return checkForm()">
    <h3>LOGIN ADMIN</h3>
...
<script type="text/javascript">
    function checkForm() {
        ...
        // Ensure the form is submitted after validation
        return true;
    }
</script>
</body>
